    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-default">
                <div class="card-header card-header-border-bottom">
                    <div class="float-left">
                        <h2 class="mt-2">Bullet Points</h2>
                    </div>
                ...
                <div class="card-body">
                    <form action="{{route('landing.store_bullets',$product->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <table role="presentation" class="table table-sm table-striped table-bordered m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$loop->index+1}}</td>
                                <td>
                                    <img style="height: 100px; width: 80px; " src="{{asset('images/whymustard/'.$dta->icon ?? '')}}" alt="">
                                </td>
                                <td>{{$dta->details}}</td>
                                <td>
                                    <form action="{{route('landing.delete_bullets',$dta->id)}}" method="POST">
                                        @method('Delete')
                                        @csrf

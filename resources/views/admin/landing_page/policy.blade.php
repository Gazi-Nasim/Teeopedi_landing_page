    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form action="{{route('landing.store_policy',$product->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <table role="presentation" class="table table-sm table-striped table-bordered m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$dta->details ?? '' }}</td>
                                <td>
                                    <form action="{{route('landing.delete_policy',$dta->id)}}" method="POST">
                                        @method('delete')
                                        @csrf

    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-default">
                <div class="card-header card-header-border-bottom">
                    <div class="float-left">
                        <h2 class="mt-2">Advantages of the product</h2>
                    </div>
                ...
                <div class="card-body">
                    <form action="{{route('landing.store_advantage',$product->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <table role="presentation" class="table table-sm table-striped table-bordered m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$dta->details ?? '' }}</td>
                                <td>
                                    <form action="{{route('landing.advantage_delete',$dta->id)}}" method="POST">
                                        @method('delete')
                                        @csrf

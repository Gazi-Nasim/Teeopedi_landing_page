...
<head>
  ...
  <title>{{$product->title}} | TEEOPEDIA</title>
  ...
  <link rel="stylesheet" id="astra-theme-css-css" href="{{asset('landing_assets/main.min.css')}}" media="all" />
  ...
  <link rel="stylesheet" id="wp-block-library-css" href="{{asset('landing_assets/style.min.css')}}" media="all" />
  ...
  <link rel="stylesheet" id="elementor-frontend-css" href="{{asset('landing_assets/frontend-lite.min.css')}}" media="all" />
  <link rel="stylesheet" id="eael-general-css" href="{{asset('landing_assets/general.min.css')}}" media="all" />
  <link rel="stylesheet" id="eael-11-css" href="{{asset('landing_assets/eael-11.css')}}" media="all" />
  <link rel="stylesheet" id="elementor-icons-css" href="{{asset('landing_assets/elementor-icons.min.css')}}" media="all" />
  ...
  <link rel="stylesheet" id="swiper-css" href="{{asset('landing_assets/swiper.min.css')}}" media="all" />
  <link rel="stylesheet" id="elementor-post-10-css" href="{{asset('landing_assets/post-10.css')}}" media="all" />
  <link rel="stylesheet" id="elementor-global-css" href="{{asset('landing_assets/global.css')}}" media="all" />
  <link rel="stylesheet" id="elementor-post-11-css" href="{{asset('landing_assets/post-11.css')}}" media="all" />
  <link rel="stylesheet" id="google-fonts-1-css" href="{{asset('landing_assets/css')}}" media="all" />
  ...
  <link rel="stylesheet" id="elementor-icons-fa-solid-css" href="/landing_assets/solid.min.css" media="all" />
  <link rel="preconnect" href="https://fonts.gstatic.com/" crossorigin="" />
  <script src="{{asset('landing_assets/jquery.min.js')}}" id="jquery-core-js"></script>
  <script src="{{asset('landing_assets/jquery-migrate.min.js')}}" id="jquery-migrate-js"></script>
...
<body class="page-template page-template-elementor_canvas page page-id-11 ast-desktop ast-page-builder-template ast-no-sidebar astra-4.3.1 ast-single-post ast-inherit-site-logo-transparent ast-hfb-header elementor-default elementor-template-canvas elementor-kit-10 elementor-page elementor-page-11 e--ua-blink e--ua-chrome e--ua-mac e--ua-webkit" style="" data-elementor-device-mode="desktop">
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            ...
            <div class="elementor-element elementor-element-a18778b elementor-widget elementor-widget-image" data-id="a18778b" data-element_type="widget" data-widget_type="image.default">
              <div class="elementor-widget-container">
                ...
                @if(isset($single->picture_one))
                <img decoding="async" fetchpriority="high" width="1024" height="1024" src="{{asset('images/main_banner/'.$single->picture_one) ?? ''}}" class="attachment-large size-large wp-image-71" alt="" srcset="{{asset('images/main_banner/'.$single->picture_one) ?? ''}} 1024w,
                {{asset('images/main_banner/'.$single->picture_one) ?? ''}} 300w,
                {{asset('images/main_banner/'.$single->picture_one) ?? ''}} 150w,
                {{asset('images/main_banner/'.$single->picture_one) ?? ''}} 768w,
                {{asset('images/main_banner/'.$single->picture_one) ?? ''}} 1536w,
                {{asset('images/main_banner/'.$single->picture_one) ?? ''}} 1600w
            ...
            <div class="elementor-element elementor-element-91bde2b elementor-align-center elementor-widget elementor-widget-button" data-id="91bde2b" data-element_type="widget" data-widget_type="button.default">
              <div class="elementor-widget-container">
                <div class="elementor-button-wrapper">
                  <a href="#order_form" class="elementor-button elementor-button-link elementor-size-sm buy_now" >
            ...
            <div class="elementor-element elementor-element-a18778b elementor-widget elementor-widget-image" data-id="a18778b" data-element_type="widget" data-widget_type="image.default">
              <div class="elementor-widget-container">
                ...
                @if(isset($single->picture_second))
                <img decoding="async" fetchpriority="high" width="1024" height="1024" src="{{asset('images/main_banner/'.$single->picture_second)}}" class="attachment-large size-large wp-image-71" alt="Advertisement Picture" sizes="(max-width: 1024px) 100vw, 1024px" />
                @endif
              </div>
            </div>
            ...
            <div class="elementor-element elementor-element-0fa9061 elementor-widget elementor-widget-image" data-id="0fa9061" data-element_type="widget" data-widget_type="image.default">
              <div class="elementor-widget-container">
                @if(isset($single->picture_third))
                <img decoding="async" loading="lazy" width="1" height="1" src="{{asset('images/main_banner/'.$single->picture_third ?? '')}}" class="attachment-large size-large wp-image-170" alt="Title Picture" />
                @endif
              </div>
            </div>
                ...
                <div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-93708b5" data-id="93708b5" data-element_type="column">
                  <div class="elementor-widget-wrap elementor-element-populated">
                    ...
                    <div class="elementor-element elementor-element-b21c7bd elementor-widget elementor-widget-heading" data-id="b21c7bd" data-element_type="widget" data-widget_type="heading.default">
                      <div class="elementor-widget-container">
                        <h2 class="elementor-heading-title elementor-size-default">
                          পূর্বের মূল্য : {{$regular_price}} টাকা
                        </h2>
                      </div>
                    </div>
                    <div class="elementor-element elementor-element-5ac6d40 elementor-widget elementor-widget-heading" data-id="5ac6d40" data-element_type="widget" data-widget_type="heading.default">
                      <div class="elementor-widget-container">
                        <h2 class="elementor-heading-title elementor-size-default">
                          বর্তমান মুল্যঃ {{$sale_price}} টাকা
                        </h2>
                      </div>
                    </div>
                    ...
                    <div class="elementor-element elementor-element-c2f0cdc elementor-align-center elementor-widget elementor-widget-button" data-id="c2f0cdc" data-element_type="widget" data-widget_type="button.default">
                      <div class="elementor-widget-container">
                        <div class="elementor-button-wrapper">
                          <a href="#order_form" class="elementor-button elementor-button-link elementor-size-sm buy_now" >
                            <span class="elementor-button-content-wrapper">
                              <span id="" class="submitButton elementor-button-text">অর্ডার করতে চাই</span>
                            </span>
                          </a>
                        </div>
                      </div>
            ...
            <section class="elementor-section elementor-inner-section elementor-element elementor-element-09938aa elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="09938aa" data-element_type="section" data-settings='{"background_background":"classic"}'>
              <div class="elementor-container elementor-column-gap-default">
                <div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-af6179d" data-id="af6179d" data-element_type="column">
                  <div class="elementor-widget-wrap elementor-element-populated">
                    <div class="elementor-element elementor-element-d084aae elementor-widget elementor-widget-heading" data-id="d084aae" data-element_type="widget" data-widget_type="heading.default">
                      <div class="elementor-widget-container" id="order_form">
                        <h2 class="elementor-heading-title elementor-size-default">
                        ...
                        <form id="" action="{{route('landing.webOrder',$product->id)}}" method="POST" enctype="multipart/form-data">
                          @csrf
                          <div class="form-row">
                            <div class="col-md-6 mb-3">
                              <label for="name" class="text-left-align"> Name <span class="required-icon">*</span></label>
                              <input type="text" autofocus class="form-control @error('name') is-invalid @enderror" placeholder="Enter name" value="{{old('name')}}" required name="name">
                              @error('name')
                            ...
                            <div class="col-md-6 mb-3">
                              <label for="phone" class="text-left-align">Phone <span class="required-icon">*</span></label>
                              <input type="text" autofocus class="form-control @error('phone') is-invalid @enderror" placeholder="Enter phone" value="{{old('phone')}}" required name="phone">
                              @error('phone')
                              <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                          ...
                          <div class="form-row">
                            <div class="col-md-6 mb-3">
                              <label for="email" class="text-left-align">Email <span class="required-icon">*</span></label>
                              <input type="text" autofocus class="form-control @error('email') is-invalid @enderror" placeholder="Enter email" value="{{old('email')}}" required name="email">
                              @error('email')
                              <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                            ...
                            <div class="col-md-6 mb-3">
                              <label for="address" class="text-left-align">Address</label>
                              <textarea class="form-control @error('address') is-invalid @enderror" name="address" rows="2" id="address" placeholder="Enter blog address" maxlength="8000">{{old('address')}}</textarea>
                              @error('address')
                              <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                          ...
                          <div class="form-row">
                            <div class="col-md-6 mb-3">
                              <label for="price" class="text-left-align"> Price </label>
                              <input type="hidden" name="price" value="{{$product->sale_price}}">
                              <input type="text" disabled class="form-control @error('price') is-invalid @enderror" name="price"  id="price" placeholder="Enter blog price" value="{{$product->sale_price}}">
                              @error('price')
                              <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                            ...
                            <div class="col-md-6 mb-3">
                              <label for="quantity" class="text-left-align"> Quantity </label>
                              <input class="form-control @error('quantity') is-invalid @enderror" name="quantity" id="quantity" value="1" placeholder="Enter blog quantity">
                              @error('quantity')
                              <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                          ...
                          <div class="form-row">
                            <div class="col-md-12 mb-3">
                              ...
                              <input type="hidden" name="sub_total" value="{{$product->sale_price}}" class="subTotal">
                              <span class="text-danger" role="alert">
                                <h2>
                                  <label class="text-left-align" for="sub_total">Total Price :</label>
                                  <strong class="subTotal2">{{$product->sale_price}}</strong>
                                </h2>
                              </span>
                            </div>
                          </div>
                          <button class="mb-1 btn cus-btn btn-primary btn-outline-warning text-white" type="submit">Order</button>
                        </form>
                      </div>
                    </div>
                  </div>
  ...
  <script src="{{asset('landing_assets/frontend.min.js')}}" id="astra-theme-js-js"></script>
  ...
  <script src="{{asset('landing_assets/general.min.js')}}" id="eael-general-js"></script>
  <script src="{{asset('landing_assets/eael-11.js')}}" id="eael-11-js"></script>
  <script src="{{asset('landing_assets/webpack.runtime.min.js')}}" id="elementor-webpack-runtime-js"></script>
  <script src="{{asset('landing_assets/frontend-modules.min.js')}}" id="elementor-frontend-modules-js"></script>
  <script src="{{asset('landing_assets/waypoints.min.js')}}" id="elementor-waypoints-js"></script>
  <script src="{{asset('landing_assets/core.min.js')}}" id="jquery-ui-core-js"></script>
  ...
  <script src="{{asset('landing_assets/frontend.min(1).js')}}" id="elementor-frontend-js"></script>

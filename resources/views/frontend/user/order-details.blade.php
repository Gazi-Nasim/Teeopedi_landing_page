                                    ...
                                    <div class="col-xl-12">
                                        <div class="bottom-text">
                                            <p >If you have any query about his invoice, please
                                                ...
                                                <a href="tel:+8801XXXXXXXXX">Mobile: +8801XXXXXXXXX</a>,
                                                <a href="mailto:info@teeopedia.com">Email: info@teeopedia.com</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="bottom-text text-center">
                                            ...
                                            <p> <a href=#>@if(!empty($settings)){{$settings->site_title}}@endif</a> &copy {{date('Y')}} | All Rights Reserved</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
